...
// source: src/main/java/com/mycompany/ejercicio02/LexicoVocalesNumeros.jflex
...
public class codigoVocalesNumeros {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    ...
    "\64\0\1\5\21\0\1\5\u0154\0\1\5\347\0";
  ...
  private static final String ZZ_ACTION_PACKED_0 =
    "\1\1\1\2\1\3\1\4\1\5\2\1\1\6\1\5"+
    "\1\7\1\6\1\10\1\7\1\11\1\10\1\1\1\11";
  ...
  private static final String ZZ_ROWMAP_PACKED_0 =
    "\0\0\0\6\0\14\0\22\0\30\0\22\0\36\0\44"+
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    ...
    "\6\0\1\6\1\5\1\6\1\7\2\0\1\5\1\10"+
    "\1\5\1\11\2\0\1\7\1\11\2\7\2\0\1\10"+
    "\1\12\1\10\1\13\2\0\1\11\1\13\2\11\2\0"+
    "\1\12\1\14\1\12\1\15\2\0\1\13\1\15\2\13"+
    "\2\0\1\14\1\16\1\14\1\17\2\0\1\15\1\17"+
    "\2\15\2\0\1\16\1\20\1\16\1\21\2\0\1\17"+
    "\1\21\2\17\2\0\3\20\3\0\1\21\1\0\2\21";
   ...
   */
  public codigoVocalesNumeros(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1:
            { seleccionarNumeros(yytext(), (yycolumn+1), (yyline+1));
            }
            // fall through
          case 10: break;
          case 2:
          ...
          case 12: break;
          case 4:
            { almacenamientoNumeros.add("Entero "+yytext()+" detectado en Fila: "+(yyline+1)+", Columna: "+ (yycolumn+1));
            }
            // fall through
          case 13: break;
          case 5:
            { incrementarContador1(); seleccionarNumeros(yytext(), (yycolumn+1), (yyline+1));
            }
            // fall through
          case 14: break;
          case 6:
            { incrementarContador2(); seleccionarNumeros(yytext(), (yycolumn+1), (yyline+1));
            }
            // fall through
          case 15: break;
          case 7:
            { incrementarContador3(); seleccionarNumeros(yytext(), (yycolumn+1), (yyline+1));
            }
            // fall through
          case 16: break;
          case 8:
            { incrementarContador4(); seleccionarNumeros(yytext(), (yycolumn+1), (yyline+1));
            }
            // fall through
          case 17: break;
          case 9:
            { incrementarContador5(); seleccionarNumeros(yytext(), (yycolumn+1), (yyline+1));
            }
            // fall through
          case 18: break;
          default:
